...
import { Eye, ShieldCheck, Clock, Award, Users, ArrowRight, Sparkles, Navigation, Car, MapPin } from "lucide-react";
...
export const metadata: Metadata = {
  title: "ADMIN PREVIEW | Home Page",
  description: "Live Draft Preview for QuickWay Ride Home Page.",
};
  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 select-none">
      ...
      <div className="bg-amber-500 text-slate-950 px-4 py-2 text-xs font-extrabold text-center uppercase tracking-wider flex items-center justify-center gap-2 shadow-md sticky top-0 z-50">
        ...
        <span>ADMIN PREVIEW MODE — Displaying Draft & Published Home Data</span>
      </div>
