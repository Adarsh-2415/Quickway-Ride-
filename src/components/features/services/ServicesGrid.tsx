...
const ALL_SERVICES: (ServiceItem & { icon: React.ReactNode; tabCategory: string })[] = [
  {
    ...
    tabCategory: "airport",
    description: "Guaranteed 24/7 airport pickups & drop-offs for Dehradun (Jolly Grant) & Delhi (IGI) Airport.",
    longDescription: "Our Airport Taxi Express provides reliable, 24/7 transfers to and from Jolly Grant Airport Dehradun and Indira Gandhi International Airport Delhi. With real-time flight tracking, your driver will be waiting at the arrival terminal even if your flight is delayed.",
